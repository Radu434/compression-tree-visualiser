  ...
  return (
    <div className="flex flex-col items-center justify-start min-h-screen bg-gray-900">
      ...
      >
        ...
        />
        {huffmanCodes && (
          <div className="flex flex-col items-center justify-center max-h-80 border-blue-800 border-2 rounded-lg overflow-hidden ">
              ...
              <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  {[...huffmanCodes.entries()]
                    .sort(([, codeA], [, codeB]) => codeA.length - codeB.length)
                    .map(([char, code], index) => (
                      <tr
                        key={index}
                      ...
                      >
                        ...
                        <td className="px-14 py-4">{code}</td>
                        <td className="px-20 py-4">{frequencyMap.get(char)}</td>
